...
- [`AZURE_COST_SHAPES.md`](../AZURE_COST_SHAPES.md) — North Europe pricing, including the unpriced NAT Gateway (A4) and the Premium-Redis delta (B4)
